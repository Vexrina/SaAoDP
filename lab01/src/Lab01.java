...
public class Lab01 {
    public static void main(String[] args) {
        ...
        choosen = 7;
        switch(choosen){
            case 1: sel_sort(mtx, Col, Row);
            case 2: ins_sort(mtx,Row,Col);
            case 3: bubble_sort(mtx,Row,Col);
            case 4: shell_sort(mtx,Row,Col);
            case 5: tournament_sort(mtx, Row, Col);
            case 6: {
                int low; int high;
                low = 0;
                high = Col-1;
    ...
    public static void tournament_sort(int mtx[][], int row, int col){
        //TODO that shit
    }
